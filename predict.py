...
spark_session = SparkSession.builder.appName("GBT Inference").getOrCreate()
gbt_model = GBTClassificationModel.load("/app/modelweights")
...
def predict_quality():
    ...
    prediction_results = gbt_model.transform(validation_data)
